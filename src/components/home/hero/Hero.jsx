      ...
      <section className="my-5" id="main_page">
        <div className="row">
          ...
          <div className="col-lg-5 col-md-6 col-sm-12">
            ...
            <Button className="mx-3 my-3" variant="primary">GET STARTED<i className="fa fa-long-arrow-alt-right"></i></Button>
            </Link>
            
            <Link to="/courses">
            <Button className="mx-3 my-3" variant="primary">VIEW COURSE<i className="fa fa-long-arrow-alt-right"></i></Button>
